 ...
 * This is similar to UA Enhanced Ecommerce's Checkout event for whichever checkout step has the user enter their payment information (https://github.com/Measurelab/gtm-dl-guide/blob/master/ec-checkout.js)
 * 
 * Push this event when the appropriate checkout step is reached where the user must enter their payment information.
 */

dataLayer.push({
    'event': 'add_payment_info',
    'ecommerce': {
        'payment_type': 'ferengi_pay',                   // The type of payment used for the purchase - optional
